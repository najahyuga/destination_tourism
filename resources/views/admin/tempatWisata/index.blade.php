                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered datatable">
                                        ...
                                        <tbody>
                                            @forelse($tempatWisata as $data)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $data->name_tw }}</td>
                                                <td>
                                                    {{-- {{dd(asset('/storage/images/' . $data->image_tw))}} --}}
                                                    {{-- <img src="{{ asset('public/images/' . $data->image_tw) }}" alt="image" class="rounded" style="width: 150px"> --}}
                                                    @if($data->image_tw)
                                                        <img src="{{ asset('/storage/images/' . $data->image_tw) }}" class="rounded" style="width: 30%" alt="image">
                                                    @else
                                                        Tidak ada gambar
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="btn-group btn-space" role="group" aria-label="Actions">
                                                        <a href="{{ route('tempatWisata.edit', $data->id) }}" class="btn btn-warning btn-rounded" style="margin-right: 10px;">Update</a>
                                                        <!-- Formulir -->
                                                        <form id="deleteForm{{ $data->id }}" action="{{ route('tempatWisata.destroy', $data->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
