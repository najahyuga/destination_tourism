                ...
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tempatWisata.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="mb-3">
                                    <label for="name_tw" class="form-label font-weight-bold">Nama Tempat Wisata</label>
                                    <input type="text" class="form-control @error('name_tw') is-invalid @enderror" id="name_tw" name="name_tw" value="{{ old('name_tw') }}" placeholder="Masukkan Nama Tempat Wisata">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi Tempat Wisata">{{ old('deskripsi') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('daerah_wisata_id') is-invalid @enderror" id="daerah_wisata_id" name="daerah_wisata_id">
                                        ...
                                        @foreach($daerahWisata as $dw)
                                            <option value="{{ $dw->id }}">{{ $dw->name_dw }}</option>
                                        @endforeach
                                    </select>
