            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="daerahWisata-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="/daerahWisata/create" class="active">
                                <i class="bi bi-circle" class="active"></i><span>Add Daerah Wisata</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            ...
                            <form action="{{ route('daerahWisata.store') }}" method="POST" enctype="multipart/form-data">

                                @csrf

                                <div class="form-group mb-3">
                                    <label class="font-weight-bold">Nama Daerah Wisata</label>
                                    <input type="text" class="form-control @error('name_dw') is-invalid @enderror" name="name_dw" value="{{ old('name_dw') }}" placeholder="Masukkan Nama Daerah Wisata!">
