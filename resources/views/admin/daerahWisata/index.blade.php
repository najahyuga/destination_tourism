    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#daerahWisata-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-journal-text"></i><span>Daerah Wisata</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="daerahWisata-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="/daerahWisata" class="active">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Daerah Wisata</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h4 class="mb-0">Data Daerah Wisata</h4>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-space" role="group" aria-label="Actions">
                                                        <a href="{{ route('daerahWisata.edit', $dw->id) }}" class="btn btn-warning btn-rounded" style="margin-right: 10px;">Update</a>
                                                        <!-- Formulir -->
                                                        <form id="deleteForm{{ $dw->id }}" action="{{ route('daerahWisata.destroy', $dw->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btn-danger btn-rounded" onclick="confirmDelete('{{ $dw->id }}')">Delete</button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
        ...
        <script>
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    text: "Anda tidak akan dapat mengembalikan data daerah wisata ini!",
                    icon: 'warning',
