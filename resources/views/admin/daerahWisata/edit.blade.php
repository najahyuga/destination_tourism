            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="/daerahWisata">Daerah Wisata</a></li>
                        <li class="breadcrumb-item active">Edit Daerah Wisata</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section">
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Daerah Wisata</h5>
                            ...
                            <form action="{{ route('daerahWisata.update', $daerahWisata->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="name_dw" class="form-control @error('name_dw') is-invalid @enderror" name="name_dw" value="{{ $daerahWisata->name_dw ?? old('name_dw') }}" placeholder="Masukkan Nama Daerah Wisata">
