...
<html lang="en">
    ...
    <body>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="fasilitasWisata-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="/fasilitasWisata/create" class="active">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Add Fasilitas Wisata</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item"><a href="/">Tempat Wisata</a></li>
                        <li class="breadcrumb-item active">Forms Add Fasilitas Wisata</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section">
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            <h5 class="card-title">Forms Add Data Fasilitas Wisata</h5>

                            <!-- Custom Styled Validation with Tooltips novalidate -->
                            <form action="{{ route('fasilitasWisata.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="mb-3">
                                    <label for="deskripsi" class="form-label font-weight-bold">Deskripsi</label>
                                    <textarea class="form-control tinymce-editor @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi Tempat Wisata">{{ old('deskripsi') }}</textarea>
