    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#fasilitasWisata-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-journal-text"></i><span>Fasilitas Wisata</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="fasilitasWisata-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="/fasilitasWisata" class="active">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Edit Fasilatas Wisata</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item "><a href="/fasilitasWisata">Fasilatas Wisata</a></li>
                        <li class="breadcrumb-item active">Edit Fasilatas Wisata</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section">
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Fasilatas Wisata</h5>

                            <!-- Custom Styled Validation with Tooltips novalidate -->
                            <form action="{{ route('fasilitasWisata.update', $fasilitas->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="mb-3">
                                    <label for="deskripsi" class="form-label font-weight-bold">Deskripsi</label>
                                    <textarea class="form-control tinymce-editor @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" placeholder="Masukkan Fasilatas Tempat Wisata">{{ old('deskripsi', $fasilitas->deskripsi) }}</textarea>
                                ...
                                <div class="mb-3">
                                    <label for="tempat_wisata_id" class="form-label font-weight-bold">Tempat Wisata Terkait</label>
                                    <select class="form-control @error('tempat_wisata_id') is-invalid @enderror" id="tempat_wisata_id" name="tempat_wisata_id">
                                        <option value="">Pilih Tempat Wisata Terkait</option>
                                        <!-- Looping untuk menampilkan opsi -->
                                        @foreach($tempatWisata as $data)
                                            <option value="{{ $data->id }}" {{ old('tempat_wisata_id', $fasilitas->tempat_wisata_id) == $data->id ? 'selected' : '' }}>{{ $data->name_tw }}</option>
                                        @endforeach
                                    </select>
