            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Fasilitas Wisata</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h4 class="mb-0">Data Tempat Wisata</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered datatable">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Deskripsi Fasilitas Wisata</th>
                                                <th>Tempat Wisata Terkait</th>
                                                <th>Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $data->tempatWisata->name_tw }}</td>
                                                <td>
                                                    <div class="btn-group btn-space" role="group" aria-label="Actions">
                                                        <a href="{{ route('fasilitasWisata.edit', $data->id) }}" class="btn btn-warning btn-rounded" style="margin-right: 10px;">Update</a>
                                                        <!-- Formulir -->
                                                        <form id="deleteForm{{ $data->id }}" action="{{ route('fasilitasWisata.destroy', $data->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-center">
                                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                        ...
                                                        Data Fasilitas wisata tidak tersedia.
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforelse
