                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h4 class="mb-0">Data Kategori Wisata</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered datatable">
                                        ...
                                        <tbody>
                                            @forelse($kategoriWisata as $kategori)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $kategori->name }}</td>
                                                <td>
                                                    <div class="btn-group btn-space" role="group" aria-label="Actions">
                                                        <a href="{{ route('kategoriWisata.edit', $kategori->id) }}" class="btn btn-warning btn-rounded" style="margin-right: 10px;">Update</a>
                                                        <!-- Formulir -->
                                                        <form id="deleteForm{{ $kategori->id }}" action="{{ route('kategoriWisata.destroy', $kategori->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btn-danger btn-rounded" onclick="confirmDelete('{{ $kategori->id }}')">Delete</button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="3" class="text-center">
                                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                        ...
                                                        Data kategori wisata tidak tersedia.
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforelse
