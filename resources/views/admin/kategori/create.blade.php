...
<html lang="en">
    ...
    <body>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="kategoriWisata-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="/kategoriWisata/create" class="active">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Add Kategori Wisata</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item active">Forms Add Kategori Wisata</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section">
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            <h5 class="card-title">Forms Add Data Kategori Wisata</h5>

                            <!-- Custom Styled Validation with Tooltips novalidate -->
                            <form action="{{ route('kategoriWisata.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="mb-3">
                                    <label for="name" class="form-label font-weight-bold">Nama Kategori Wisata</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan Nama Kategori Wisata">
