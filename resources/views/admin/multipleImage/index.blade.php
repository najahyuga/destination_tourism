                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h4 class="mb-0">Data Multiple Image - Tempat Wisata</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('/storage/images/' . $data->image) }}" class="rounded" style="width: 50%" alt="image">
                                                </td>
                                                <td>
                                                    <img src="{{ asset('/storage/images/' . $data->image_satu) }}" class="rounded" style="width: 50%" alt="image_satu">
                                                </td>
                                                <td>
                                                    <img src="{{ asset('/storage/images/' . $data->image_dua) }}" class="rounded" style="width: 30%" alt="image_dua">
                                                </td>
                                                <td>
                                                    <div class="btn-group btn-space" role="group" aria-label="Actions">
                                                        <a href="{{ route('imageWisata.edit', $data->id) }}" class="btn btn-warning btn-rounded" style="margin-right: 10px;">Update</a>
                                                        <!-- Formulir -->
                                                        <form id="deleteForm{{ $data->id }}" action="{{ route('imageWisata.destroy', $data->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btn-danger btn-rounded" onclick="confirmDelete('{{ $data->id }}')">Delete</button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-center">
                                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                        ...
                                                        Data tempat wisata tidak tersedia.
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforelse
        ...
        <script>
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    text: "Anda tidak akan dapat mengembalikan data multiple - image tempat wisata ini!",
                    icon: 'warning',
