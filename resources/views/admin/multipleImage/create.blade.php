...
<html lang="en">
    ...
    <body>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="tempatWisata-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="/tempatWisata/create"  class="active">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Add Multiple Image - Tempat Wisata</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item"><a href="/imageWisata">Tempat Wisata</a></li>
            ...
            <section class="section">
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            <h5 class="card-title">Forms Add Data Multiple Image - Tempat Wisata</h5>

                            <!-- Custom Styled Validation with Tooltips novalidate -->
                            <form action="{{ route('imageWisata.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('tempat_wisata_id') is-invalid @enderror" id="tempat_wisata_id" name="tempat_wisata_id">
                                        ...
                                        @foreach($tempatWisata as $data)
                                            <option value="{{ $data->id }}">{{ $data->name_tw }}</option>
                                        @endforeach
                                    </select>

                                    <!-- error message untuk Tempat wisata -->
