...
<html lang="en">
    <head>
        ...
        <title>Multiple Image - Tempat Wisata</title>
    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#imageWisata-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-journal-text"></i><span>Image Wisata</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="imageWisata-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="/imageWisata" class="active">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="/imageWisata">Multiple Image - Tempat Wisata</a></li>
                        <li class="breadcrumb-item active">Edit Multiple Image - Tempat Wisata</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section">
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Multiple Image - Tempat Wisata</h5>

                            <!-- Custom Styled Validation with Tooltips novalidate -->
                            <form action="{{ route('imageWisata.update', $image->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    <label for="image_satu" class="form-label font-weight-bold">Gambar Satu</label>
                                    <input type="file" class="form-control @error('image_satu') is-invalid @enderror" id="image_satu" name="image_satu">
                                    @error('image_satu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="image_dua" class="form-label font-weight-bold">Gambar Dua</label>
                                    <input type="file" class="form-control @error('image_dua') is-invalid @enderror" id="image_dua" name="image_dua">
                                    @error('image_dua')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="tempat_wisata_id" class="form-label font-weight-bold">Tempat Wisata</label>
                                    <select class="form-control @error('tempat_wisata_id') is-invalid @enderror" id="tempat_wisata_id" name="tempat_wisata_id">
                                        <option value="">Pilih Tempat Wisata</option>
                                        @foreach($tempatWisata as $data)
                                            <option value="{{ $data->id }}" {{ $imageWisata->tempat_wisata_id == $data->id ? 'selected' : '' }}>{{ $data->name_tw }}</option>
                                        @endforeach
                                    </select>
